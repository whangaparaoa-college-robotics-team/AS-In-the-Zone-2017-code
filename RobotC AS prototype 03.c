...
#pragma config(Motor,  port4,           LiftMotor1,    tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port5,           LiftMotor2,    tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port6,           ClawMotor,     tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port7,           LiftMotor3,    tmotorVex269_MC29, openLoop, reversed)
...
Update 17.10.17: Added a 3rd lift motor*/
